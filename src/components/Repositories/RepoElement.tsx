...
const RepoElement: FC<RepoElementP> = ({ repoData }) => {
  ...
  return (
    <motion.div
      ...
      className="w-auto sm:w-md md:w-lg lg:w-3xl flex justify-between text-left gap-4 text-blue-600 dark:text-white bg-blue-300 hover:bg-blue-400 dark:bg-gray-800 hover:dark:bg-gray-700 p-3 rounded-xl"
    >
      <div className="flex gap-4 items-center w-full">
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex text-xs text-blue-600 dark:text-gray-300 w-full">
            {repoData.description}
          </div>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center mr-2">
        <LuStar size={24} color={theme === "light" ? "#ffffff" : "#ffb86a"} />
